...
<head>
    ...
    <title>University of Greenwich | All Ideas</title>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="lists">
                    ...
                    <li class="list">
                        <a href="allideas_administrator.php" class="nav_link active">
        ...
        <div class="container" style="margin-top: 100px;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">All Ideas</li>
                </ol>
              </nav>
