        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="lists">
                    ...
                    <li class="list">
                        <a href="attachmentfiles_administrator.php" class="nav_link active">
    ...
    <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        echo "<td>
                            <button type='button' style='outline: none; border: none; border-radius: 6px; cursor: pointer; padding: 5px; color: #FFFFFF; background-color: #000080;'>
                                <a style='text-decoration: none; color: #FFFFFF;' href='attachmentfiles_administrator.php?IdeaID=$IdeaID'>
                                <i class='bx bxs-download p-1 align-items-center justify-content-center align-middle'></i></a>
                            </button>
                        </td>";
