        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="lists">
                    ...
                    <li class="list">
                        <a href="category_qamanager.php" class="nav_link active">
    ...
    <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        {
                            echo '<p><a href="categorystatus_qamanager.php?CategoryID=' . $rows['CategoryID'] . '&CategoryStatus=1" class="badge badge-success">Active</a></p>';
                        }
                        else
                        {
                            echo '<p><a href="categorystatus_qamanager.php?CategoryID=' . $rows['CategoryID'] . '&CategoryStatus=0" class="badge badge-danger">Inactive</a></p>';
                        }
                        ?>
                        </td>
                        <td>
                        <a href="" type="button" data-toggle="modal" data-target="#updateModal<?php echo $rows['CategoryID']?>">Edit</a> | <a href="deletecategory_qamanager.php?CategoryID=<?php echo $CategoryID?>">Delete</a>
                        </td>
                        <?php
                            echo "</tr>";
                            include ('updatecategory_qamanager.php');
                            }
                        }
                        ?>
                    </tbody>
