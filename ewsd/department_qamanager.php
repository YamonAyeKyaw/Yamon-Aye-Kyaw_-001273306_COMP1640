        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="lists">
                    ...
                    <li class="list">
                        <a href="department_qamanager.php" class="nav_link active">
    ...
    <div class="table-container">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <td>
                        <a href="" type="button" data-toggle="modal" data-target="#updateModal<?php echo $rows['DepartmentID']?>">Edit</a> | <a href="deletedepartment_qamanager.php?DepartmentID=<?php echo $DepartmentID?>">Delete</a>
                        </td>
                        <?php
                        echo "</tr>";
                        include ('updatedepartment_qamanager.php');
                        }
                        ?>
                    </tbody>
                  </table>
