...
<head>
    ...
    <title>University of Greenwich | Most Popular Ideas</title>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="lists">
                    ...
                    <li class="list">
                        <a href="mostpopularideas_administrator.php" class="nav_link active">
        ...
        <div class="container" style="margin-top: 100px;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Most Popular Ideas</li>
                </ol>
              </nav>
            ...
            <?php
            $result = mysqli_query($connection,"SELECT idea.*, academicyear.*, category.*, user.*, COUNT(likes.IdeaID) AS like_count
                                                FROM idea
                                                ...
                                                LEFT JOIN likes ON likes.IdeaID = idea.IdeaID AND likes.Reaction = 'like'
                    ...
                    <div class="col-lg-12">
                        <div class="idea-post w-100">
                            ...
                            <button type="button" class="btn btn-link see" style="font-weight: 500; padding: 0; margin: 0;">
                                <?php echo "<a href='ideadetails_administrator.php?IdeaID=". $row['IdeaID'] ."'>See more</a";?>
                            </button>
                            </div>
