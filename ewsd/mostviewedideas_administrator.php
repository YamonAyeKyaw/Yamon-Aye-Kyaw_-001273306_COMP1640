...
<head>
    ...
    <title>University of Greenwich | Most Viewed Ideas</title>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                <ul class="lists">
                    ...
                    <li class="list">
                        <a href="mostviewedideas_administrator.php" class="nav_link active">
        ...
        <div class="container" style="margin-top: 100px;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Most Viewed Ideas</li>
                </ol>
              </nav>
