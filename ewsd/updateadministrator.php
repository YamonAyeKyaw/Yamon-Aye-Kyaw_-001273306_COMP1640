...
if (isset($_REQUEST['AdministratorID'])){
    $AdministratorID=$_REQUEST['AdministratorID'];
    $select="SELECT * 
             FROM administrator
...
<head>
    ...
    <title>University of Greenwich | Update Administrator</title>
    ...
    <main style="padding-bottom: 50px;">
        <div class="container" style="margin-top: 100px;">
            <div class="col-lg-12 text-left mb-2" style="padding: 0px;">
                <a href="administrator.php" class="btn btn-link" style="font-weight: 500; padding: 6px 0px;"><i class='uil uil-angle-left' style="font-size: 1.5em; vertical-align: middle;"></i>Back to Administrator List</a>
            </div>
                        <div class="register p-lg-9 p-sm-0">
                            <section class="form-container">
                                <span class="title">Update Administrator</span>
                                <form action="updateadministrator.php" method="POST" enctype="multipart/form-data" class="form">
