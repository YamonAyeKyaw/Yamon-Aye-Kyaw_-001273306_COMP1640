...
if(isset($_POST['btnUpdate']))
{
	...
	if($updatequery)  //TRUE
	{
		...
		echo "<script>window.location='updateuserbyself_staff.php'</script>";
	}
    else    //FALSE
    {
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-content">
                ...
                <div class="bottom-content">
                    <ul>
                        <li class="list">
                            <a href="updateuserbyself_staff.php" class="nav_link active">
        ...
        <div class="container" style="margin-top: 100px;">
                        <div class="register p-lg-9 p-sm-0">
                            <section class="form-container" >
                                ...
                                <form action="updateuserbyself_staff.php" method="POST" enctype="multipart/form-data" class="form">
